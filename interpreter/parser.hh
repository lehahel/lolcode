...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // factor
      // term
      char dummy1[sizeof (CExpression *)];

      // object
      char dummy2[sizeof (LolObject)];
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, CExpression *&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const CExpression *& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, LolObject&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const LolObject& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yytype)
    {
      ...
      case 41: // factor
      case 42: // term
        value.template destroy< CExpression * > ();
        break;

      case 39: // object
        value.template destroy< LolObject > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YYASSERT (tok == token::TOK_END || tok == token::TOK_ENDING || tok == token::TOK_BEGIN || tok == token::TOK_ASSIGN || tok == token::TOK_DEFINE || tok == token::TOK_PLUS || tok == token::TOK_MINUS || tok == token::TOK_STAR || tok == token::TOK_SLASH || tok == token::TOK_MOD || tok == token::TOK_AND || tok == token::TOK_OR || tok == token::TOK_LPAREN || tok == token::TOK_RPAREN || tok == token::TOK_YR || tok == token::TOK_LOOP || tok == token::TOK_TILL || tok == token::TOK_WHILE || tok == token::TOK_IF || tok == token::TOK_DO || tok == token::TOK_ELSE || tok == token::TOK_INC || tok == token::TOK_DEC || tok == token::TOK_ENDIF || tok == token::TOK_EOL || tok == 288 || tok == 289 || tok == 290 || tok == 291 || tok == 292);
      }
#else
      ...
      symbol_type (int tok, const char* v, location_type l)
        : super_type(token_type (tok), std::move (v), std::move (l))
      {
        YYASSERT (tok == token::TOK_CSTRING);
      }
#else
      ...
      symbol_type (int tok, std::string v, location_type l)
        : super_type(token_type (tok), std::move (v), std::move (l))
      {
        YYASSERT (tok == token::TOK_IDENTIFIER || tok == token::TOK_STRING);
      }
#else
    ...
    parser (Scanner &scanner_yyarg, CDriver &driver_yyarg);
    virtual ~parser ();
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_ENDING (location_type l)
      {
        return symbol_type (token::TOK_ENDING, std::move (l));
      }
#else
      static
      symbol_type
      make_ENDING (const location_type& l)
      {
        return symbol_type (token::TOK_ENDING, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_YR (location_type l)
      {
        return symbol_type (token::TOK_YR, std::move (l));
      }
#else
      static
      symbol_type
      make_YR (const location_type& l)
      {
        return symbol_type (token::TOK_YR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_TILL (location_type l)
      {
        return symbol_type (token::TOK_TILL, std::move (l));
      }
#else
      static
      symbol_type
      make_TILL (const location_type& l)
      {
        return symbol_type (token::TOK_TILL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_ENDIF, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_ENDIF, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_CSTRING (const char* v, location_type l)
      {
        return symbol_type (token::TOK_CSTRING, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_CSTRING (const const char*& v, const location_type& l)
      {
        return symbol_type (token::TOK_CSTRING, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    , location (std::move (that.location))
  {
    switch (this->type_get ())
    {
      ...
      case 41: // factor
      case 42: // term
        value.move< CExpression * > (std::move (that.value));
        break;

      case 39: // object
        value.move< LolObject > (std::move (that.value));
        break;
    ...
    , location (that.location)
  {
    switch (this->type_get ())
    {
      ...
      case 41: // factor
      case 42: // term
        value.copy< CExpression * > (YY_MOVE (that.value));
        break;

      case 39: // object
        value.copy< LolObject > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->type_get ())
    {
      ...
      case 41: // factor
      case 42: // term
        value.move< CExpression * > (YY_MOVE (s.value));
        break;

      case 39: // object
        value.move< LolObject > (YY_MOVE (s.value));
        break;
